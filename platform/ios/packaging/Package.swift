...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RustPlayerFFI",
            url: "https://github.com/Preclikos/rust_player_learning/releases/download/ios-v0.1.33/RustPlayerFFI.xcframework.zip",
            checksum: "8f2b29185e937e9822c41c547563896df8402f390e9063c8055fb707b8b27190"
        ),
        .target(
            name: "RustPlayer",

...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RustPlayerFFI",
            url: "https://github.com/Preclikos/rust_player_learning/releases/download/ios-v0.1.6/RustPlayerFFI.xcframework.zip",
            checksum: "a9f305fec95559e91f0ac9a30c2063cdf2e79da93b774bcbcd11c52acb36bfe3"
        ),
        .target(
            name: "RustPlayer",

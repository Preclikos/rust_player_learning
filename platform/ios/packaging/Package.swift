...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RustPlayerFFI",
            url: "https://github.com/Preclikos/rust_player_learning/releases/download/ios-v0.1.37/RustPlayerFFI.xcframework.zip",
            checksum: "0c82ee993cf9e08015c71cacc57269237a87086452b96ac73017bb0941dbb349"
        ),
        .target(
            name: "RustPlayer",

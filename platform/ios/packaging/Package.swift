...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RustPlayerFFI",
            url: "https://github.com/Preclikos/rust_player_learning/releases/download/ios-v0.1.32/RustPlayerFFI.xcframework.zip",
            checksum: "e33504d5be096ebdff750fba0cf944310470b5c7b2143419b3dd383def2d0e23"
        ),
        .target(
            name: "RustPlayer",

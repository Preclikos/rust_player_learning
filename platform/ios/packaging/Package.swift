...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RustPlayerFFI",
            url: "https://github.com/Preclikos/rust_player_learning/releases/download/ios-v0.1.10/RustPlayerFFI.xcframework.zip",
            checksum: "9280641df8b0219e8a1825c9a224297a6389696f769588f2429331ffbc91ebd0"
        ),
        .target(
            name: "RustPlayer",

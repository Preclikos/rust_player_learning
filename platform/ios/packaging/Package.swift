...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RustPlayerFFI",
            url: "https://github.com/Preclikos/rust_player_learning/releases/download/ios-v0.1.7/RustPlayerFFI.xcframework.zip",
            checksum: "b7a2218a5c28e0494d40be45c12e4bf954946900d50d98bdd2c5cfc9b16738c9"
        ),
        .target(
            name: "RustPlayer",

...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RustPlayerFFI",
            url: "https://github.com/Preclikos/rust_player_learning/releases/download/ios-v0.1.36/RustPlayerFFI.xcframework.zip",
            checksum: "9912bca9827ca59e2bd323b1b9bfdbef30ef006d6e91b02b5a149c2fe23a8313"
        ),
        .target(
            name: "RustPlayer",

...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RustPlayerFFI",
            url: "https://github.com/Preclikos/rust_player_learning/releases/download/ios-v0.1.8/RustPlayerFFI.xcframework.zip",
            checksum: "6b48634d91bfd111896926303bb773ad1051f693fac0fd6b28bb199e0ea5abf0"
        ),
        .target(
            name: "RustPlayer",

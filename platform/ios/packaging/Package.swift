...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RustPlayerFFI",
            url: "https://github.com/Preclikos/rust_player_learning/releases/download/ios-v0.1.38/RustPlayerFFI.xcframework.zip",
            checksum: "f18f55fecb3cf9b802256cc9799d98820fe719fc39f00e49f31b6a6c79a8ee36"
        ),
        .target(
            name: "RustPlayer",

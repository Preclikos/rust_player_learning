...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "RustPlayerFFI",
            url: "https://github.com/Preclikos/rust_player_learning/releases/download/ios-v0.1.35/RustPlayerFFI.xcframework.zip",
            checksum: "c8d66fa4dc4692ef389e29fc8c6a4337a55d0f9cf565d34f53b878cbfc9f752d"
        ),
        .target(
            name: "RustPlayer",

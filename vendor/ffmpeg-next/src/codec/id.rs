...
impl From<AVCodecID> for Id {
    fn from(value: AVCodecID) -> Self {
        match value {
            ...
            // Wildcard for variants added in FFmpeg point releases past 8.1.0
            // (e.g. AV_CODEC_ID_WEBP_ANIM from release/8.1 branch backports).
            // Remove once ffmpeg-next 8.1.1+ ships upstream.
            _ => Id::None,
        }
    }
}

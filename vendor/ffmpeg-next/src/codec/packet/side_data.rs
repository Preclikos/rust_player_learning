...
impl From<AVPacketSideDataType> for Type {
    fn from(value: AVPacketSideDataType) -> Self {
        match value {
            ...
            // Wildcard for variants added in FFmpeg 8.1.1+ point-release backports
            // (DYNAMIC_HDR_SMPTE_2094_APP5, HEVC_CONF). Player never reads packet
            // side_data, so this path is unreachable in practice.
            _ => unreachable!(),
        }
    }
}
